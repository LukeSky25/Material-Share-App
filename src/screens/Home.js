...
import {
    ...
    ScrollView,
    TouchableOpacity,
    // Adicionado Linking para simular a abertura do site
    Linking, 
} from 'react-native';
...
// --- NOVO Componente de Cartão para Acesso ao Site ---
const WebsiteAccessCard = () => {
    // Simula a URL do site para a doação
    const websiteURL = 'https://www.materialshare.com.br/operacoes'; 

    const handlePress = () => {
        // Na aplicação real, você usaria o Linking do React Native para abrir o site
    ...
    return (
        <View style={aboutStyles.websiteCard}>
            ...
            <View style={{ flex: 1, marginLeft: 15 }}>
                <Text style={aboutStyles.websiteCardTitle}>Realize Doações e Solicitações</Text>
                <Text style={aboutStyles.websiteCardDescription}>
                    Para iniciar operações de doação, recebimento, cadastro de projetos e acompanhamento, acesse nosso portal exclusivo pelo site.
                </Text>
            </View>
            <TouchableOpacity style={aboutStyles.websiteCardButton} onPress={handlePress}>
                <Text style={aboutStyles.websiteCardButtonText}>Acessar Site</Text>
                <Feather name="arrow-right" size={16} color={CARD_BG} style={{ marginLeft: 5 }} />
            </TouchableOpacity>
        </View>
    );
};
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: LIGHT_BG }}>
            ...
            <ScrollView contentContainerStyle={aboutStyles.scrollContainer}>
                ...
                {/* --- NOVO BLOCO: Acesso ao Site para Operações --- */}
                <WebsiteAccessCard />
                {/* -------------------------------------------------- */}
...
const aboutStyles = StyleSheet.create({
    ...
    // --- Novos Estilos para o WebsiteAccessCard ---
    websiteCard: {
        width: '100%',
        maxWidth: 700,
        flexDirection: 'row',
        ...
        elevation: 6,
        borderLeftWidth: 5,
        borderLeftColor: PRIMARY_BLUE, // Borda de cor para destaque
    },
    websiteCardTitle: {
        fontSize: 18,
        fontWeight: '700',
